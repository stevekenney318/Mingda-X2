...
enum ADCSensorState : char {
  ...
  #endif
  #if HAS_MOTORS_OCP
    PrepareCurrentMotors, MeasureCurrentMotors,
  #endif
  #if HAS_HOTEND_OCP
    PrepareCurrentHotend, MeasureCurrentHotend,
  #endif
  #if HAS_BED_OCP
    PrepareCurrentBed, MeasureCurrentBed,
  #endif
...
class Temperature {
  ...
  public:
      ...
      static uint16_t heater_mintemp[HOTENDS];
...
extern Temperature thermalManager;
 ...
 #if HAS_MOTORS_OCP
  extern temp_info_t motors_current_info;
 #endif
 #if HAS_HOTEND_OCP
  extern temp_info_t hotend_current_info;
 #endif
 #if HAS_BED_OCP
  extern temp_info_t bed_current_info;
 #endif
#endif
