 ...
 */
  ...
  #error "SERIAL_PORT_3 cannot be the same as SERIAL_PORT. Please update your configuration."
#endif

#if defined(SERIAL_PORT_2) && defined(SERIAL_PORT_3)
  #if SERIAL_PORT_2 == SERIAL_PORT_3
    #error "SERIAL_PORT_3 cannot be the same as SERIAL_PORT_2. Please update your configuration."
  #endif
#endif
