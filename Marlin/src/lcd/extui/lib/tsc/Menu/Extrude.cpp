...
static  ITEM itemLen[ITEM_LEN_NUM] = {
// icon                       label
  {ICON_E_1_MM,               LABEL_1_MM},
  {ICON_E_10_MM,              LABEL_10_MM},
  {ICON_E_50_MM,              LABEL_BACKGROUND},
};
const  uint8_t item_len[ITEM_LEN_NUM] = {1, 10, 50};
...
void menuExtrude()
{
  ...
  itemLen[2].label.address = (uint8_t*)"50mm";
  extrudeItems.items[5] = itemSpeed[item_speed_i];
  extrudeItems.items[6] = itemLen[item_len_i];
...
void menuExtrude2()
{
  ...
  statusMsg.tagHotend = -1;
  itemLen[2].label.address = (uint8_t*)"50mm";
  extrude2Items.items[5] = itemSpeed[item_speed_i];
  extrude2Items.items[6] = itemLen[item_len_i];
