...
#define _LANGUAGE_EN_H_
    ...
    #define EN_PROBE_OFFSET         "Z Offset"
    ...
    #define EN_TFTSD                "SD"
    #define EN_READ_TFTSD_ERROR     "Read SD card error!"
    ...
    #define EN_CHOOSE_STORAGE       "Select storage device:"
    #define EN_UNDER_VOLTAGE        "Insufficient voltage"
    #define EN_OVERCURRENT_PROTECTION "Overcurrent protection"
    #define EN_X_LEVELING           "X axis leveling"
