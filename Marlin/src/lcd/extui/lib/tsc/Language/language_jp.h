...
#define _LANGUAGE_JP_H_
    ...
    #define JP_SILENT_ON            "ミュートする"
    #define JP_SILENT_OFF           "ミュートオフ"
    ...
    #define JP_PROBE_OFFSET         "Z オフセット"
    ...
    #define JP_RUNOUT_OFF           "断材検査オフ"
    #define JP_RUNOUT_ON            "断材検知開放"
    ...
    #define JP_PREHEAT              "予熱"
    #define JP_PREHEAT_BOTH         "どちらも"
    ...
    #define JP_CHOOSE_STORAGE       "記憶装置の選択です:"
    #define JP_UNDER_VOLTAGE        "不十分な電圧"
    #define JP_OVERCURRENT_PROTECTION "過電流保護"
    #define JP_X_LEVELING           "x軸レベリング"
