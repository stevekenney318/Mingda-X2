...
// 土耳其语
const char *const tu_pack[LABEL_NUM]={
  TU_LANGUAGE,
  TU_HEAT,
  TU_MOVE,
  TU_HOME,
  ...
  TU_TFTSD_REMOVED,
  TU_U_DISK,
  TU_READ_U_DISK_ERROR,
  TU_U_DISK_INSERTED,
  TU_U_DISK_REMOVED,
  TU_ONBOARDSD,
  TU_READ_ONBOARDSD_ERROR,
  TU_FILAMENT_RUNOUT,
  TU_PREHEAT,
  TU_PREHEAT_BOTH,
  TU_PREHEAT_PLA,
  ...
  TU_TOUCH_TO_EXIT,
  TU_MAINMENU,
  TU_WAIT_TEMP_SHUT_DOWN,
  TU_FORCE_SHUT_DOWN,
  TU_SHUTTING_DOWN,
  TU_PRINTING_COMPLETED,
  TU_STATUS_INFO,
  TU_ERROR,
  TU_TIPS,
  TU_EEPROM_SAVE_SUCCESS,
  TU_EEPROM_SAVE_FAILED,
  TU_ELAPSED_TIME,
  TU_SAVE_POPUP,
  TU_SYCHRONZIED_VALUE,
  TU_CHOOSE_STORAGE,
  TU_UNDER_VOLTAGE,
  TU_OVERCURRENT_PROTECTION,
  TU_X_LEVELING,
};
