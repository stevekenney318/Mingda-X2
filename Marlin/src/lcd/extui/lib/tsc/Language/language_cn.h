...
#define _LANGUAGE_CN_H_
    ...
    #define CN_TFTSD                "SD卡"
    #define CN_READ_TFTSD_ERROR     "读SD卡出错!"
    ...
    #define CN_PRINTING_COMPLETED   "打印已完成!"
    #define CN_STATUS_INFO          "状态信息"
    #define CN_ERROR                "严重错误"
    #define CN_TIPS                 "提示"
    ...
    #define CN_UNDER_VOLTAGE        "电压不足"
    #define CN_OVERCURRENT_PROTECTION "电流过载保护"
    #define CN_X_LEVELING           "X轴水平校准"
