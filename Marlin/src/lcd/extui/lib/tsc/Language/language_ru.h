...
#define _LANGUAGE_RU_H_
    ...
    #define RU_RUNOUT_OFF           "Закончиться Выкл"
    #define RU_RUNOUT_ON            "Закончиться Вкл"
    #define RU_SMART_RUNOUT_ON      "Закончиться Умный"
    ...
    #define RU_CHOOSE_STORAGE       "Выберите устройство хранения:"
    #define RU_UNDER_VOLTAGE        "Недостаточное напряжение"
    #define RU_OVERCURRENT_PROTECTION "Защита от сверхтока"
    #define RU_X_LEVELING           "выравнивание по оси X"
