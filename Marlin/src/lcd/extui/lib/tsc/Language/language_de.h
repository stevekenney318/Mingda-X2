...
#define _LANGUAGE_DE_H_
    ...
    #define DE_CHOOSE_STORAGE       "Auswahl des Speichergeräts:"
    #define DE_UNDER_VOLTAGE        "Unter Spannung"
    #define DE_OVERCURRENT_PROTECTION "Überstromschutz"
    #define DE_X_LEVELING           "Nivellierung der x-Achse"
