...
#define _LANGUAGE_FR_H_
    ...
    #define FR_SILENT_ON            "Silence On"
    #define FR_SILENT_OFF           "Silence Off"
    #define FR_SHUT_DOWN            "Éteindre"
    #define FR_RGB_SETTINGS         "Couleurs LED"
    ...
    #define FR_CUSTOM               "Personnalisation"
    ...
    #define FR_BLTOUCH_DEPLOY       "Sortir"
    #define FR_BLTOUCH_STOW         "Rentrer"
    #define FR_BLTOUCH_REPEAT       "Répéter"
    #define FR_PROBE_OFFSET         "Décalage en Z"
    #define FR_EEPROM_SAVE          "Sauvegarder"
    #define FR_INC                  "Augementer"
    #define FR_DEC                  "Diminuer"
    ...
    #define FR_ADJUST_FAILED        "Ajustement incorrect, veuillez essayer de nouveau"
    ...
    #define FR_AUTO_SHUT_DOWN       "Arrêt automatique"
    #define FR_MANUAL_SHUT_DOWN     "Arrêt manul"
    ...
    #define FR_FORCE_SHUT_DOWN      "Forcer l’arrêt"
    #define FR_SHUTTING_DOWN        "Arrêt en cours..."
    #define FR_PRINTING_COMPLETED   "Impression terminée!"
    #define FR_STATUS_INFO          "Info"
    #define FR_ERROR                "Erreur"
    #define FR_TIPS                 "Astuces"
    #define FR_EEPROM_SAVE_SUCCESS  "Paramètres EEPROM sauvegardés"
    #define FR_EEPROM_SAVE_FAILED   "Echec de sauvegarde des paramètres EEPROM"
    ...
    #define FR_CHOOSE_STORAGE       "Sélectionner un périphérique de stockage:"
    #define FR_UNDER_VOLTAGE        "Tension insuffisante"
    #define FR_OVERCURRENT_PROTECTION "Protection contre les surintensités"
    #define FR_X_LEVELING           "mise à niveau sur l'axe x"
