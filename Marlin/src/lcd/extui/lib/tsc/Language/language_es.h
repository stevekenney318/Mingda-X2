...
#define _LANGUAGE_ES_H_
    ...
    #define ES_EEPROM_SAVE          "Guardada"
    #define ES_INC                  "Aumentar"
    #define ES_DEC                  "Disminuir"
    #define ES_NOZZLE               "Boquilla"
    #define ES_BED                  "Cama"
    #define ES_STOP                 "Parar"
    #define ES_BACK                 "Volver"
    #define ES_PAGE_UP              "Página arriba"
    #define ES_PAGE_DOWN            "Página abajo"
    ...
    #define ES_MORE                 "Más"
    #define ES_SCREEN_INFO          "Información"
    ...
    #define ES_RUNOUT_OFF           "Rotura de sensor Apagado"
    #define ES_RUNOUT_ON            "Rotura de sensor Encendido"
    #define ES_SMART_RUNOUT_ON      "Sensor Inteligente Encendido"
    ...
    #define ES_DISCONNECT_INFO      "¡Ahora puede controlar la impresora por su ordenador!"
    ...
    #define ES_ADJUST_INFO          "Por favor haga clic en el punto rojo para calibrar"
    #define ES_ADJUST_OK            "Ajuste correcto"
    #define ES_ADJUST_FAILED        "Ajuste fallido, por favor volver a intentarlo"
    #define ES_WARNING              "Advertencia"
    #define ES_STOP_PRINT           "¿Desea parar la impresión?"
    #define ES_CONFIRM              "Confirmar"
    #define ES_TFTSD                "la tarjeta SD"
    #define ES_READ_TFTSD_ERROR     "¡Error en la tarjeta SD!"
    #define ES_TFTSD_INSERTED       "¡Tarjeta insertada!"
    #define ES_TFTSD_REMOVED        "¡Tarjeta extraida!"
    #define ES_U_DISK               "U disk"
    #define ES_READ_U_DISK_ERROR    "¡Error en el U disk!"
    #define ES_U_DISK_INSERTED      "¡U disk insertado!"
    #define ES_U_DISK_REMOVED       "¡U disk extraido!"
    ...
    #define ES_UNIFIEDHEAT          "Temperatura"
    ...
    #define ES_PRINTING_COMPLETED   "Imprimir con éxito!"
    #define ES_STATUS_INFO          "Información"
    ...
    #define ES_CHOOSE_STORAGE       "Seleziona un dispositivo di archiviazione:"
    #define ES_UNDER_VOLTAGE        "Tensione insufficiente"
    #define ES_OVERCURRENT_PROTECTION "Protezione da sovracorrente"
    #define ES_X_LEVELING           "nivelación del eje x"
