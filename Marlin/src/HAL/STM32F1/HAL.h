...
#define MSERIAL(X) _MSERIAL(X)
  ...
  #elif NUM_UARTS == 5
    #error "SERIAL_PORT_3 must be -1 or from 1 to 5. Please update your configuration."
  #else
    #error "SERIAL_PORT_3 must be -1 or from 1 to 3. Please update your configuration."
  #endif
#endif
