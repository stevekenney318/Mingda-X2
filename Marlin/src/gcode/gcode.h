...
public:
  ...
  static void report_heading(const bool forReplay, const char* fstr, const bool eol=true);
  static void report_heading_etc(const bool forReplay, const char* fstr, const bool eol=true) {
  ...
  // report 
  static void report_M92(const bool forReplay=true, const int8_t e=-1);
  #if HAS_SHAPING
    static void report_M593(const bool forReplay=true);
  #endif

  static void report_M1200();
