...
//
  ...
  //#define Z_MULTI_ENDSTOPS
    ...
    #define Z2_USE_ENDSTOP          _ZDIAG_   // 当没有定义Z2_***_PIN和Z2_MIN_ENDSTOP_INVERTING的时候，可以帮你定义，详见Marlin\src\inc\Conditionals_post.h 914行
    #define Z2_ENDSTOP_ADJUSTMENT   0         // 是否需要在复位完成后调节两Z电机的相对定位，0为否，正值ZA抬高，负值ZB抬高，详见Marlin\src\module\motion.cpp 1730行
...
// #define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  120.2         // (Hz) The default dominant resonant frequency on the X axis.
...
// @section lcd
 ...
 #else
  #define MANUAL_FEEDRATE { 60*60, 60*60, 20*60, 1*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 #endif
